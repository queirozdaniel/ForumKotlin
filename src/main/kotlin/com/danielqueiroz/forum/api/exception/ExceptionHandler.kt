package com.danielqueiroz.forum.api.exception

import com.danielqueiroz.forum.api.dto.ErrorView
...
class ExceptionHandler {
    ...
    fun handleValidation(exception: MethodArgumentNotValidException, request: HttpServletRequest) : ErrorView {
